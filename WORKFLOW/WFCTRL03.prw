...
dDataFim := dDatabase - 3
//dDataIni := CTOD('01/01/15')
//dDataFim := CTOD('28/02/15')
//
dbSelectarea("ZZ6")
...
If Len(aEnvia) > 0
	...
	oProcess :cSubject := "WFCTRL03 - Monitoramento Semamal de Perdas no processo"
	...
	Qout("WFCTRL03 - E-mail enviado com sucesso!!!")
EndIf
//
Return(lRet)
